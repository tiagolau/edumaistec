...
export const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Após a matrícula, você acessa a plataforma, realiza as avaliações online e envia seus documentos. É necessário um aproveitamento mínimo de 70%. Caso não atinja a nota em algum módulo, você pode refazer a avaliação daquele módulo específico.",
    order: 5,
  },
  {
    id: "6",
    ...
    answer:
      "O tempo de conclusão depende do dia da realização da prova. Após a aprovação, em até 48 horas você recebe o diploma digital.",
    order: 6,
  },
  {
    id: "7",
  ...
  },
  {
    ...
    answer:
      "As mensalidades são acessíveis, a partir de R$ 89,00. Oferecemos parcelamento em até 12 vezes sem juros no cartão de crédito. Entre em contato com nossa equipe para conhecer os valores e promoções vigentes.",
    order: 8,
  },
  {
    id: "9",
    ...
    answer:
      "Após a conclusão de todas as avaliações e aprovação (mínimo 70%), o certificado é emitido em formato digital com código autenticador do SISTEC. O documento tem validade nacional e pode ser utilizado imediatamente no mercado de trabalho, concursos e registro em conselhos profissionais.",
    order: 9,
  },
  {
    id: "10",
    ...
    answer:
      `Você pode entrar em contato conosco pelo WhatsApp ${INSTITUTION.contacts.whatsapp} para atendimento comercial e suporte. Também estamos disponíveis pelo e-mail ${INSTITUTION.contacts.email}. Atendemos de segunda a sexta, das 8h às 18h.`,
    order: 10,
  },
];
